# 🌟 Superfunctional Training System (SFT)
...
## 🏗️ System Components (Directories)
...
- **Activate Framework:** `activate_framework` 🟢
...
- **Assess Emotion:** `assess: emotional_state` 🔍
...
- **Lock Mode:** `lock: mode_selection` 🔒 (Prevents automatic switching for a period)

### 💪 Framework Focus Commands (Directing AI's Training Emphasis):
...
### 🍽️ Nutrition Interaction Examples:

_(These illustrate interacting with the nutrition component, not base commands)_

- Log Food: `client: 150g chicken breast, 1 cup broccoli, 1/2 cup brown rice` 🥗
- Select Diet: `Select diet: Reset Diet` 🍳
- Set Region: `Regional foods: Egypt` 🌍
- Calculate Needs: `Calculate TDEE` 📊

### ⚠️ Emergency Commands:

- `emergency: reset` 🔄 (Resets framework state if issues arise)
